...
return [
    ...
    'Select Spaces here on which the content is to be additionally displayed.' => 'Sélectionnez ici les espaces sur lesquels le contenu doit être affiché en plus.',
    'Share' => 'Partager',
    'Share Content' => 'Partager le contenu',
    'Share this content on your profile stream' => 'Partagez ce contenu sur le fil d\'actualité de votre profil',
    ...
    'Whenever content (e.g. a post) is shared by a user.' => 'Dès qu’un contenu (par exemple une publication) est partagé par quelqu’un.',
